...
const translations = {
  en: {
    ...
    analysis: {
      ...
      deviationScoliosis: 'Mild Scoliosis',
      deviationForwardHead: 'Forward Head Posture',
      deviationShoulderProtraction: 'Shoulder Protraction',
  ...
  pt: {
    ...
    dashboard: {
      ...
      openStudents: 'Abrir gestão de alunos',
      openSchedule: 'Abrir agenda de hoje',
      ...
      noSessions: 'Nenhuma sessão agendada para hoje.',
    ...
    analysis: {
      ...
      deviationScoliosis: 'Escoliose Leve',
      deviationForwardHead: 'Postura de Cabeça Projetada',
      deviationShoulderProtraction: 'Protração dos Ombros',
